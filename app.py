...
model = joblib.load('Logistic_Regression_Original_model_Ultimate_Guitar.pkl')
vectorizer = joblib.load('tfidf_vectorizer_Ultimate_Guitar.pkl')
label_encoder = joblib.load('label_encoder_Ultimate_Guitar.pkl')
...
# === Judul Aplikasi ===
st.title("🎸 Aplikasi Analisis Sentimen – Ultimate Guitar")
    ...
    if st.button("🚀 Prediksi Sentimen"):
        if user_review.strip() == "":
            ...
            st.download_button(
                ...
                data=csv_manual,
                file_name="hasil_prediksi_manual_ultimate_guitar.csv",
                mime="text/csv"
            )
    ...
    if uploaded_file:
        try:
            ...
            if not required_cols.issubset(df.columns):
                ...
                ax_bar.set_title("Distribusi Sentimen Pengguna – Ultimate Guitar")
                st.pyplot(fig_bar)
                ...
                st.download_button(
                    ...
                    data=csv_result,
                    file_name="hasil_prediksi_ultimate_guitar.csv",
                    mime="text/csv"
                )
